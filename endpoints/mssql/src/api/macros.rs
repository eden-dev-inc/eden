...
macro_rules! mssql_endpoint {
    (
        ...
        paste::paste! {
            #[derive(Debug, serde::Deserialize, Clone, Default, derive_builder::Builder, utoipa::ToSchema, schemars::JsonSchema, endpoint_derive::DocumentInput)]
            #[builder(setter(into))]
            ...
            #[ctor::ctor]
            fn [<__register_mssql_operation_for_ $kind>]() {
