...
use crate::api::lib::params::{build_query_body, filters_to_params};
...
const API_INFO: ApiInfo<AwsApi, Ec2DescribeTagsInput> =
    ApiInfo::new(EpKind::Aws, AwsApi::Ec2DescribeTags, "ec2_describe_tags", ReqType::Read, true);
...
impl SimpleInput {
    ...
    async fn run_async_generic(&self, context: AwsAsync, telemetry_wrapper: &mut TelemetryWrapper) -> ResultEP<Box<dyn EpOutput>> {
        ...
        let form_body = build_query_body("DescribeTags", "2016-11-15", &params);
...
mod tests {
    ...
    #[test]
    fn builder_serde() {
        let input = Ec2DescribeTagsInputBuilder::default()
        ...
        assert_eq!(json["type"], "ec2_describe_tags");
    }

    #[test]
    fn deserialize_minimal() {
        let json = serde_json::json!({});
        let _: Ec2DescribeTagsInput = serde_json::from_value(json).unwrap();
    }
}
