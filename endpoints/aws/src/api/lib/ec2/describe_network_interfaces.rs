...
const API_INFO: ApiInfo<AwsApi, Ec2DescribeNetworkInterfacesInput> = ApiInfo::new(
    EpKind::Aws,
    AwsApi::Ec2DescribeNetworkInterfaces,
...
crate::aws_endpoint! {
    ...
    struct {
        ...
        filters: Option<Vec<crate::api::lib::types::AwsFilter>>,
...
impl SimpleInput {
    ...
    async fn run_async_generic(&self, context: AwsAsync, telemetry_wrapper: &mut TelemetryWrapper) -> ResultEP<Box<dyn EpOutput>> {
        ...
        if let Some(ids) = &self.network_interface_ids {
            params.extend(indexed_list_params("NetworkInterfaceId", ids));
        }
        ...
        let form_body = build_query_body("DescribeNetworkInterfaces", "2016-11-15", &params);
...
mod tests {
    ...
    #[test]
    fn builder_serde() {
        let input = Ec2DescribeNetworkInterfacesInputBuilder::default()
            .network_interface_ids(None::<Vec<String>>)
        ...
        assert_eq!(json["type"], "ec2_describe_network_interfaces");
    }

    #[test]
    fn deserialize_minimal() {
        let json = serde_json::json!({});
        let _: Ec2DescribeNetworkInterfacesInput = serde_json::from_value(json).unwrap();
    }
}
