...
const API_INFO: ApiInfo<AwsApi, DocDbCreateDbClusterInput> =
    ApiInfo::new(EpKind::Aws, AwsApi::DocDbCreateDbCluster, "docdb_create_db_cluster", ReqType::Write, true);
...
mod tests {
    ...
    #[test]
    fn builder_serde() {
        let input = DocDbCreateDbClusterInputBuilder::default()
        ...
        assert_eq!(json["type"], "docdb_create_db_cluster");
    }
    ...
    fn deserialize_minimal() {
        ...
        let _: DocDbCreateDbClusterInput = serde_json::from_value(json).unwrap();
    }
}
