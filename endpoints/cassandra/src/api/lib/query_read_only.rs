...
const API_INFO: ApiInfo<CassandraApi, QueryReadOnlyInput> =
    ApiInfo::new(EpKind::Cassandra, CassandraApi::QueryReadOnly, "Cassandra read-only Query", ReqType::Read, true);
