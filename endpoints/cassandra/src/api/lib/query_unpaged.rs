...
const API_INFO: ApiInfo<CassandraApi, QueryUnpagedInput> =
    ApiInfo::new(EpKind::Cassandra, CassandraApi::QueryUnpaged, "Cassandra Query Unpaged", ReqType::Write, true);
