...
macro_rules! postgres_endpoint {
    (
        ...
        paste::paste! {
            ...
            impl [<$kind Input>] {
                #[allow(dead_code)]
                fn postgres_operation_todo() {
                    todo!("Determine if we want to derive here or in the postgres crate")
                }
            ...
            #[ctor::ctor]
            fn [<__register_postgres_operation_for_ $kind>]() {
