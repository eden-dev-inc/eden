...
const API_INFO: ApiInfo<PostgresApi, QueryReadOnlyInput> = ApiInfo::new(
    EpKind::Postgres,
    PostgresApi::QueryReadOnly,
    "Executes a read-only parameterized SQL query and returns results from PostgreSQL",
    ReqType::Read,
    true,
);
