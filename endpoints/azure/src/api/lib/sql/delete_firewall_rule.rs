...
const API_INFO: ApiInfo<AzureApi, SqlDeleteFirewallRuleInput> = ApiInfo::new(
    EpKind::Azure,
    AzureApi::SqlDeleteFirewallRule,
    "Delete a SQL server firewall rule",
    ReqType::Write,
    true,
);
...
mod tests {
    ...
    #[test]
    fn builder_serde() {
        let input = SqlDeleteFirewallRuleInputBuilder::default()
        ...
        assert_eq!(json["type"], "sql_delete_firewall_rule");
    }
    ...
    fn deserialize_minimal() {
        ...
        let _: SqlDeleteFirewallRuleInput = serde_json::from_value(json).unwrap();
    }
}
