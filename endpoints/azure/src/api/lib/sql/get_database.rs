...
const API_INFO: ApiInfo<AzureApi, SqlGetDatabaseInput> =
    ApiInfo::new(EpKind::Azure, AzureApi::SqlGetDatabase, "Get a SQL database", ReqType::Read, true);
...
mod tests {
    ...
    #[test]
    fn builder_serde() {
        let input = SqlGetDatabaseInputBuilder::default()
        ...
        assert_eq!(json["type"], "sql_get_database");
    }
    ...
    fn deserialize_minimal() {
        ...
        let _: SqlGetDatabaseInput = serde_json::from_value(json).unwrap();
    }
}
