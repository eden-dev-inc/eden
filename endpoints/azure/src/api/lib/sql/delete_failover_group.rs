...
const API_INFO: ApiInfo<AzureApi, SqlDeleteFailoverGroupInput> =
    ApiInfo::new(EpKind::Azure, AzureApi::SqlDeleteFailoverGroup, "Delete a SQL failover group", ReqType::Write, true);
...
mod tests {
    ...
    #[test]
    fn builder_serde() {
        let input = SqlDeleteFailoverGroupInputBuilder::default()
        ...
        assert_eq!(json["type"], "sql_delete_failover_group");
    }
    ...
    fn deserialize_minimal() {
        ...
        let _: SqlDeleteFailoverGroupInput = serde_json::from_value(json).unwrap();
    }
}
