...
const API_INFO: ApiInfo<AzureApi, SqlDeleteDatabaseInput> =
    ApiInfo::new(EpKind::Azure, AzureApi::SqlDeleteDatabase, "Delete a SQL database", ReqType::Write, true);
...
mod tests {
    ...
    #[test]
    fn builder_serde() {
        let input = SqlDeleteDatabaseInputBuilder::default()
        ...
        assert_eq!(json["type"], "sql_delete_database");
    }
    ...
    fn deserialize_minimal() {
        ...
        let _: SqlDeleteDatabaseInput = serde_json::from_value(json).unwrap();
    }
}
