...
const API_INFO: ApiInfo<AzureApi, SqlGetElasticPoolInput> =
    ApiInfo::new(EpKind::Azure, AzureApi::SqlGetElasticPool, "Get a SQL elastic pool", ReqType::Read, true);
...
mod tests {
    ...
    #[test]
    fn builder_serde() {
        let input = SqlGetElasticPoolInputBuilder::default()
        ...
        assert_eq!(json["type"], "sql_get_elastic_pool");
    }
    ...
    fn deserialize_minimal() {
        ...
        let _: SqlGetElasticPoolInput = serde_json::from_value(json).unwrap();
    }
}
