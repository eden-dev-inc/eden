...
const API_INFO: ApiInfo<AzureApi, SqlFailoverFailoverGroupInput> = ApiInfo::new(
    EpKind::Azure,
    AzureApi::SqlFailoverFailoverGroup,
    "Failover a SQL failover group",
    ReqType::Write,
    true,
);
...
mod tests {
    ...
    #[test]
    fn builder_serde() {
        let input = SqlFailoverFailoverGroupInputBuilder::default()
        ...
        assert_eq!(json["type"], "sql_failover_failover_group");
    }
    ...
    fn deserialize_minimal() {
        ...
        let _: SqlFailoverFailoverGroupInput = serde_json::from_value(json).unwrap();
    }
}
