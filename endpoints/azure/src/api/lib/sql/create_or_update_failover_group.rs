...
const API_INFO: ApiInfo<AzureApi, SqlCreateOrUpdateFailoverGroupInput> = ApiInfo::new(
    EpKind::Azure,
    AzureApi::SqlCreateOrUpdateFailoverGroup,
    "Create or update a SQL failover group",
    ReqType::Write,
    true,
);
...
mod tests {
    ...
    #[test]
    fn builder_serde() {
        let input = SqlCreateOrUpdateFailoverGroupInputBuilder::default()
        ...
        assert_eq!(json["type"], "sql_create_or_update_failover_group");
    }
    ...
    fn deserialize_minimal() {
        ...
        let _: SqlCreateOrUpdateFailoverGroupInput = serde_json::from_value(json).unwrap();
    }
}
