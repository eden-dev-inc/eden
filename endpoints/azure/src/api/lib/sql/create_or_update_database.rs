...
const API_INFO: ApiInfo<AzureApi, SqlCreateOrUpdateDatabaseInput> = ApiInfo::new(
    EpKind::Azure,
    AzureApi::SqlCreateOrUpdateDatabase,
...
mod tests {
    ...
    #[test]
    fn builder_serde() {
        let input = SqlCreateOrUpdateDatabaseInputBuilder::default()
        ...
        assert_eq!(json["type"], "sql_create_or_update_database");
    }
    ...
    fn deserialize_minimal() {
        ...
        let _: SqlCreateOrUpdateDatabaseInput = serde_json::from_value(json).unwrap();
    }
}
