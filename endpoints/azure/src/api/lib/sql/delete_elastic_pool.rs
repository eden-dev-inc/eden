...
const API_INFO: ApiInfo<AzureApi, SqlDeleteElasticPoolInput> =
    ApiInfo::new(EpKind::Azure, AzureApi::SqlDeleteElasticPool, "Delete an elastic pool", ReqType::Write, true);
...
mod tests {
    ...
    #[test]
    fn builder_serde() {
        let input = SqlDeleteElasticPoolInputBuilder::default()
        ...
        assert_eq!(json["type"], "sql_delete_elastic_pool");
    }
    ...
    fn deserialize_minimal() {
        ...
        let _: SqlDeleteElasticPoolInput = serde_json::from_value(json).unwrap();
    }
}
