...
const API_INFO: ApiInfo<AzureApi, EventGridGetEventSubscriptionInput> = ApiInfo::new(
    EpKind::Azure,
    AzureApi::EventGridGetEventSubscription,
    "Get an EventGrid event subscription",
    ReqType::Read,
    true,
);
