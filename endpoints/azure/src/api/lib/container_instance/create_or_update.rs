...
const API_INFO: ApiInfo<AzureApi, ContainerInstanceCreateOrUpdateInput> = ApiInfo::new(
    EpKind::Azure,
    AzureApi::ContainerInstanceCreateOrUpdate,
...
mod tests {
    ...
    #[test]
    fn builder_serde() {
        let input = ContainerInstanceCreateOrUpdateInputBuilder::default()
        ...
        assert_eq!(json["type"], "container_instance_create_or_update");
    }

    #[test]
    fn deserialize_minimal() {
        let json = serde_json::json!({"resource_group": "my-rg", "container_group_name": "my-cg", "location": "eastus", "properties": {}});
        let _: ContainerInstanceCreateOrUpdateInput = serde_json::from_value(json).unwrap();
    }
}
