...
const API_INFO: ApiInfo<AzureApi, KeyVaultCreateOrUpdateVaultInput> = ApiInfo::new(
    EpKind::Azure,
    AzureApi::KeyVaultCreateOrUpdateVault,
...
mod tests {
    ...
    #[test]
    fn builder_serde() {
        let input = KeyVaultCreateOrUpdateVaultInputBuilder::default()
            .resource_group("my-rg")
            .vault_name("my-vault")
            .location("eastus")
            .properties(serde_json::json!({"tenantId": "00000000-0000-0000-0000-000000000000"}))
            .build()
            .unwrap();
        let json = serde_json::to_value(&input).unwrap();
        assert_eq!(json["type"], "keyvault_create_or_update_vault");
    }
    ...
    fn deserialize_minimal() {
        ...
        let _: KeyVaultCreateOrUpdateVaultInput = serde_json::from_value(json).unwrap();
    }
}
