...
const API_INFO: ApiInfo<AzureApi, StorageSetBlobServicePropertiesInput> = ApiInfo::new(
    EpKind::Azure,
    AzureApi::StorageSetBlobServiceProperties,
...
mod tests {
    ...
    #[test]
    fn builder_serde() {
        let input = StorageSetBlobServicePropertiesInputBuilder::default()
        ...
        assert_eq!(json["type"], "storage_set_blob_service_properties");
    }

    #[test]
    fn deserialize_minimal() {
        let json = serde_json::json!({"resource_group": "my-rg", "account_name": "mystorage", "properties": {}});
        let _: StorageSetBlobServicePropertiesInput = serde_json::from_value(json).unwrap();
    }
}
