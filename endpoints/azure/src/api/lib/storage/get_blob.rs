...
const API_INFO: ApiInfo<AzureApi, StorageGetBlobInput> =
    ApiInfo::new(EpKind::Azure, AzureApi::StorageGetBlob, "Get a blob", ReqType::Read, true);
...
mod tests {
    ...
    #[test]
    fn builder_serde() {
        let input = StorageGetBlobInputBuilder::default()
        ...
        assert_eq!(json["type"], "storage_get_blob");
    }
    ...
    fn deserialize_minimal() {
        ...
        let _: StorageGetBlobInput = serde_json::from_value(json).unwrap();
    }
}
