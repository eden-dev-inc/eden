...
const API_INFO: ApiInfo<AzureApi, PurviewCreateOrUpdateAccountInput> = ApiInfo::new(
    EpKind::Azure,
    AzureApi::PurviewCreateOrUpdateAccount,
...
mod tests {
    ...
    #[test]
    fn builder_serde() {
        let input = PurviewCreateOrUpdateAccountInputBuilder::default()
        ...
        assert_eq!(json["type"], "purview_create_or_update_account");
    }

    #[test]
    fn deserialize_minimal() {
        let json = serde_json::json!({"resource_group": "my-rg", "account_name": "my-account", "location": "eastus", "properties": {}});
        let _: PurviewCreateOrUpdateAccountInput = serde_json::from_value(json).unwrap();
    }
}
