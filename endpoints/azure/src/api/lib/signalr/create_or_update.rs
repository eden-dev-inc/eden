...
const API_INFO: ApiInfo<AzureApi, SignalRCreateOrUpdateInput> = ApiInfo::new(
    EpKind::Azure,
    AzureApi::SignalRCreateOrUpdate,
    "Create or update a SignalR instance",
    ReqType::Write,
    true,
);
...
mod tests {
    ...
    #[test]
    fn builder_serde() {
        let input = SignalRCreateOrUpdateInputBuilder::default()
        ...
        assert_eq!(json["type"], "signalr_create_or_update");
    }

    #[test]
    fn deserialize_minimal() {
        let json = serde_json::json!({"resource_group": "my-rg", "signalr_name": "my-signalr", "location": "eastus", "properties": {}});
        let _: SignalRCreateOrUpdateInput = serde_json::from_value(json).unwrap();
    }
}
