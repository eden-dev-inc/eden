...
const API_INFO: ApiInfo<AzureApi, LogicAppsCreateOrUpdateWorkflowInput> = ApiInfo::new(
    EpKind::Azure,
    AzureApi::LogicAppsCreateOrUpdateWorkflow,
...
mod tests {
    ...
    #[test]
    fn builder_serde() {
        let input = LogicAppsCreateOrUpdateWorkflowInputBuilder::default()
        ...
        assert_eq!(json["type"], "logic_apps_create_or_update_workflow");
    }

    #[test]
    fn deserialize_minimal() {
        let json = serde_json::json!({"resource_group": "my-rg", "workflow_name": "my-workflow", "location": "eastus", "properties": {}});
        let _: LogicAppsCreateOrUpdateWorkflowInput = serde_json::from_value(json).unwrap();
    }
}
