...
const API_INFO: ApiInfo<AzureApi, CognitiveUpdateAccountInput> = ApiInfo::new(
    EpKind::Azure,
    AzureApi::CognitiveUpdateAccount,
...
mod tests {
    ...
    #[test]
    fn builder_serde() {
        let input = CognitiveUpdateAccountInputBuilder::default()
        ...
        assert_eq!(json["type"], "cognitive_update_account");
    }

    #[test]
    fn deserialize_minimal() {
        let json = serde_json::json!({"resource_group": "my-rg", "account_name": "my-account", "properties": {}});
        let _: CognitiveUpdateAccountInput = serde_json::from_value(json).unwrap();
    }
}
