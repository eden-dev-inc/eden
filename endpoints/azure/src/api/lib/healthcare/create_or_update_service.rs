...
const API_INFO: ApiInfo<AzureApi, HealthcareCreateOrUpdateServiceInput> = ApiInfo::new(
    EpKind::Azure,
    AzureApi::HealthcareCreateOrUpdateService,
    "Create or update a Healthcare service",
    ReqType::Write,
    true,
);
...
mod tests {
    ...
    #[test]
    fn builder_serde() {
        let input = HealthcareCreateOrUpdateServiceInputBuilder::default()
        ...
        assert_eq!(json["type"], "healthcare_create_or_update_service");
    }

    #[test]
    fn deserialize_minimal() {
        let json = serde_json::json!({"resource_group": "my-rg", "service_name": "my-svc", "location": "eastus", "properties": {}});
        let _: HealthcareCreateOrUpdateServiceInput = serde_json::from_value(json).unwrap();
    }
}
