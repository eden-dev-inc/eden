...
const API_INFO: ApiInfo<AzureApi, DnsCreateOrUpdateRecordSetInput> = ApiInfo::new(
    EpKind::Azure,
    AzureApi::DnsCreateOrUpdateRecordSet,
...
mod tests {
    ...
    #[test]
    fn builder_serde() {
        let input = DnsCreateOrUpdateRecordSetInputBuilder::default()
        ...
        assert_eq!(json["type"], "dns_create_or_update_record_set");
    }

    #[test]
    fn deserialize_minimal() {
        let json = serde_json::json!({"resource_group": "my-rg", "zone_name": "example.com", "record_type": "A", "record_name": "www", "properties": {}});
        let _: DnsCreateOrUpdateRecordSetInput = serde_json::from_value(json).unwrap();
    }
}
