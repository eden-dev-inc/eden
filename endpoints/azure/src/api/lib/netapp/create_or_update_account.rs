...
const API_INFO: ApiInfo<AzureApi, NetAppCreateOrUpdateAccountInput> = ApiInfo::new(
    EpKind::Azure,
    AzureApi::NetAppCreateOrUpdateAccount,
...
mod tests {
    ...
    #[test]
    fn builder_serde() {
        let input = NetAppCreateOrUpdateAccountInputBuilder::default()
        ...
        assert_eq!(json["type"], "net_app_create_or_update_account");
    }

    #[test]
    fn deserialize_minimal() {
        let json = serde_json::json!({"resource_group": "my-rg", "account_name": "my-account", "location": "eastus", "properties": {}});
        let _: NetAppCreateOrUpdateAccountInput = serde_json::from_value(json).unwrap();
    }
}
