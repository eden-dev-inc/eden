...
const API_INFO: ApiInfo<AzureApi, AutomationCreateOrUpdateAccountInput> = ApiInfo::new(
    EpKind::Azure,
    AzureApi::AutomationCreateOrUpdateAccount,
...
mod tests {
    ...
    #[test]
    fn builder_serde() {
        let input = AutomationCreateOrUpdateAccountInputBuilder::default()
        ...
        assert_eq!(json["type"], "automation_create_or_update_account");
    }

    #[test]
    fn deserialize_minimal() {
        let json = serde_json::json!({"resource_group": "my-rg", "account_name": "my-account", "location": "eastus", "properties": {}});
        let _: AutomationCreateOrUpdateAccountInput = serde_json::from_value(json).unwrap();
    }
}
