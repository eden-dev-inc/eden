...
const API_INFO: ApiInfo<AzureApi, MlCreateOrUpdateComputeInput> = ApiInfo::new(
    EpKind::Azure,
    AzureApi::MlCreateOrUpdateCompute,
    "Create or update a Machine Learning compute",
    ReqType::Write,
    true,
);
...
mod tests {
    ...
    #[test]
    fn builder_serde() {
        let input = MlCreateOrUpdateComputeInputBuilder::default()
        ...
        assert_eq!(json["type"], "ml_create_or_update_compute");
    }
    ...
    fn deserialize_minimal() {
        ...
        let _: MlCreateOrUpdateComputeInput = serde_json::from_value(json).unwrap();
    }
}
