...
const API_INFO: ApiInfo<AzureApi, MlCreateOrUpdateOnlineEndpointInput> = ApiInfo::new(
    EpKind::Azure,
    AzureApi::MlCreateOrUpdateOnlineEndpoint,
...
mod tests {
    ...
    #[test]
    fn builder_serde() {
        let input = MlCreateOrUpdateOnlineEndpointInputBuilder::default()
        ...
        assert_eq!(json["type"], "ml_create_or_update_online_endpoint");
    }

    #[test]
    fn deserialize_minimal() {
        let json = serde_json::json!({"resource_group": "my-rg", "workspace_name": "my-ws", "endpoint_name": "my-ep", "location": "eastus", "properties": {}});
        let _: MlCreateOrUpdateOnlineEndpointInput = serde_json::from_value(json).unwrap();
    }
}
