...
const API_INFO: ApiInfo<AzureApi, MlDeleteOnlineDeploymentInput> = ApiInfo::new(
    EpKind::Azure,
    AzureApi::MlDeleteOnlineDeployment,
...
mod tests {
    ...
    #[test]
    fn builder_serde() {
        let input = MlDeleteOnlineDeploymentInputBuilder::default()
        ...
        assert_eq!(json["type"], "ml_delete_online_deployment");
    }
    ...
    fn deserialize_minimal() {
        ...
        let _: MlDeleteOnlineDeploymentInput = serde_json::from_value(json).unwrap();
    }
}
