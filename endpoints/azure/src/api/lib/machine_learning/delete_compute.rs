...
const API_INFO: ApiInfo<AzureApi, MlDeleteComputeInput> =
    ApiInfo::new(EpKind::Azure, AzureApi::MlDeleteCompute, "Delete a Machine Learning compute", ReqType::Write, true);
...
mod tests {
    ...
    #[test]
    fn builder_serde() {
        let input = MlDeleteComputeInputBuilder::default()
        ...
        assert_eq!(json["type"], "ml_delete_compute");
    }
    ...
    fn deserialize_minimal() {
        ...
        let _: MlDeleteComputeInput = serde_json::from_value(json).unwrap();
    }
}
