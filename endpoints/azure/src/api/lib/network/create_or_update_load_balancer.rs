...
const API_INFO: ApiInfo<AzureApi, NetworkCreateOrUpdateLoadBalancerInput> = ApiInfo::new(
    EpKind::Azure,
    AzureApi::NetworkCreateOrUpdateLoadBalancer,
...
mod tests {
    ...
    #[test]
    fn builder_serde() {
        let input = NetworkCreateOrUpdateLoadBalancerInputBuilder::default()
        ...
        assert_eq!(json["type"], "network_create_or_update_load_balancer");
    }

    #[test]
    fn deserialize_minimal() {
        let json = serde_json::json!({"resource_group": "my-rg", "load_balancer_name": "my-lb", "location": "eastus", "properties": {}});
        let _: NetworkCreateOrUpdateLoadBalancerInput = serde_json::from_value(json).unwrap();
    }
}
