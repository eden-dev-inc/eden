...
const API_INFO: ApiInfo<AzureApi, NetworkCreateOrUpdatePrivateEndpointInput> = ApiInfo::new(
    EpKind::Azure,
    AzureApi::NetworkCreateOrUpdatePrivateEndpoint,
...
mod tests {
    ...
    #[test]
    fn builder_serde() {
        let input = NetworkCreateOrUpdatePrivateEndpointInputBuilder::default()
        ...
        assert_eq!(json["type"], "network_create_or_update_private_endpoint");
    }

    #[test]
    fn deserialize_minimal() {
        let json = serde_json::json!({"resource_group": "my-rg", "private_endpoint_name": "my-pe", "location": "eastus", "properties": {}});
        let _: NetworkCreateOrUpdatePrivateEndpointInput = serde_json::from_value(json).unwrap();
    }
}
