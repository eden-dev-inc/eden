...
const API_INFO: ApiInfo<AzureApi, NetworkCreateOrUpdatePrivateDnsZoneInput> = ApiInfo::new(
    EpKind::Azure,
    AzureApi::NetworkCreateOrUpdatePrivateDnsZone,
...
mod tests {
    ...
    #[test]
    fn builder_serde() {
        let input = NetworkCreateOrUpdatePrivateDnsZoneInputBuilder::default()
        ...
        assert_eq!(json["type"], "network_create_or_update_private_dns_zone");
    }

    #[test]
    fn deserialize_minimal() {
        let json = serde_json::json!({"resource_group": "my-rg", "zone_name": "my-zone", "location": "global", "properties": {}});
        let _: NetworkCreateOrUpdatePrivateDnsZoneInput = serde_json::from_value(json).unwrap();
    }
}
