...
const API_INFO: ApiInfo<AzureApi, NetworkCreateOrUpdateNetworkWatcherInput> = ApiInfo::new(
    EpKind::Azure,
    AzureApi::NetworkCreateOrUpdateNetworkWatcher,
...
mod tests {
    ...
    #[test]
    fn builder_serde() {
        let input = NetworkCreateOrUpdateNetworkWatcherInputBuilder::default()
        ...
        assert_eq!(json["type"], "network_create_or_update_network_watcher");
    }

    #[test]
    fn deserialize_minimal() {
        let json = serde_json::json!({"resource_group": "my-rg", "network_watcher_name": "my-nw", "location": "eastus", "properties": {}});
        let _: NetworkCreateOrUpdateNetworkWatcherInput = serde_json::from_value(json).unwrap();
    }
}
