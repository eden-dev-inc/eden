...
const API_INFO: ApiInfo<AzureApi, NetworkCreateOrUpdateApplicationGatewayInput> = ApiInfo::new(
    EpKind::Azure,
    AzureApi::NetworkCreateOrUpdateApplicationGateway,
...
mod tests {
    ...
    #[test]
    fn builder_serde() {
        let input = NetworkCreateOrUpdateApplicationGatewayInputBuilder::default()
        ...
        assert_eq!(json["type"], "network_create_or_update_application_gateway");
    }

    #[test]
    fn deserialize_minimal() {
        let json =
            serde_json::json!({"resource_group": "my-rg", "application_gateway_name": "my-appgw", "location": "eastus", "properties": {}});
        let _: NetworkCreateOrUpdateApplicationGatewayInput = serde_json::from_value(json).unwrap();
    }
}
