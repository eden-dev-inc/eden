...
const API_INFO: ApiInfo<AzureApi, NetworkCreateOrUpdatePublicIpAddressInput> = ApiInfo::new(
    EpKind::Azure,
    AzureApi::NetworkCreateOrUpdatePublicIpAddress,
...
mod tests {
    ...
    #[test]
    fn builder_serde() {
        let input = NetworkCreateOrUpdatePublicIpAddressInputBuilder::default()
        ...
        assert_eq!(json["type"], "network_create_or_update_public_ip_address");
    }

    #[test]
    fn deserialize_minimal() {
        let json = serde_json::json!({"resource_group": "my-rg", "public_ip_name": "my-pip", "location": "eastus", "properties": {}});
        let _: NetworkCreateOrUpdatePublicIpAddressInput = serde_json::from_value(json).unwrap();
    }
}
