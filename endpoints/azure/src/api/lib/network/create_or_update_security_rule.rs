...
const API_INFO: ApiInfo<AzureApi, NetworkCreateOrUpdateSecurityRuleInput> = ApiInfo::new(
    EpKind::Azure,
    AzureApi::NetworkCreateOrUpdateSecurityRule,
...
mod tests {
    ...
    #[test]
    fn builder_serde() {
        let input = NetworkCreateOrUpdateSecurityRuleInputBuilder::default()
        ...
        assert_eq!(json["type"], "network_create_or_update_security_rule");
    }

    #[test]
    fn deserialize_minimal() {
        let json = serde_json::json!({"resource_group": "my-rg", "nsg_name": "my-nsg", "security_rule_name": "my-rule", "properties": {}});
        let _: NetworkCreateOrUpdateSecurityRuleInput = serde_json::from_value(json).unwrap();
    }
}
