...
const API_INFO: ApiInfo<AzureApi, NetworkCreateOrUpdateVirtualNetworkInput> = ApiInfo::new(
    EpKind::Azure,
    AzureApi::NetworkCreateOrUpdateVirtualNetwork,
...
mod tests {
    ...
    #[test]
    fn builder_serde() {
        let input = NetworkCreateOrUpdateVirtualNetworkInputBuilder::default()
        ...
        assert_eq!(json["type"], "network_create_or_update_virtual_network");
    }

    #[test]
    fn deserialize_minimal() {
        let json = serde_json::json!({"resource_group": "my-rg", "vnet_name": "my-vnet", "location": "eastus", "properties": {}});
        let _: NetworkCreateOrUpdateVirtualNetworkInput = serde_json::from_value(json).unwrap();
    }
}
