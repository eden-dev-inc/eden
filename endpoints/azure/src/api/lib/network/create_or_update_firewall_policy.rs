...
const API_INFO: ApiInfo<AzureApi, NetworkCreateOrUpdateFirewallPolicyInput> = ApiInfo::new(
    EpKind::Azure,
    AzureApi::NetworkCreateOrUpdateFirewallPolicy,
...
mod tests {
    ...
    #[test]
    fn builder_serde() {
        let input = NetworkCreateOrUpdateFirewallPolicyInputBuilder::default()
        ...
        assert_eq!(json["type"], "network_create_or_update_firewall_policy");
    }

    #[test]
    fn deserialize_minimal() {
        let json = serde_json::json!({"resource_group": "my-rg", "firewall_policy_name": "my-fp", "location": "eastus", "properties": {}});
        let _: NetworkCreateOrUpdateFirewallPolicyInput = serde_json::from_value(json).unwrap();
    }
}
