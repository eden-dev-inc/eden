...
const API_INFO: ApiInfo<AzureApi, NetworkDeletePrivateDnsRecordSetInput> = ApiInfo::new(
    EpKind::Azure,
    AzureApi::NetworkDeletePrivateDnsRecordSet,
    "Delete a private DNS record set",
    ReqType::Write,
    true,
);
...
mod tests {
    ...
    #[test]
    fn builder_serde() {
        let input = NetworkDeletePrivateDnsRecordSetInputBuilder::default()
        ...
        assert_eq!(json["type"], "network_delete_private_dns_record_set");
    }
    ...
    fn deserialize_minimal() {
        ...
        let _: NetworkDeletePrivateDnsRecordSetInput = serde_json::from_value(json).unwrap();
    }
}
