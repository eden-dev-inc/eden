...
const API_INFO: ApiInfo<AzureApi, NetworkCreateOrUpdateRouteTableInput> = ApiInfo::new(
    EpKind::Azure,
    AzureApi::NetworkCreateOrUpdateRouteTable,
...
mod tests {
    ...
    #[test]
    fn builder_serde() {
        let input = NetworkCreateOrUpdateRouteTableInputBuilder::default()
        ...
        assert_eq!(json["type"], "network_create_or_update_route_table");
    }

    #[test]
    fn deserialize_minimal() {
        let json = serde_json::json!({"resource_group": "my-rg", "route_table_name": "my-rt", "location": "eastus", "properties": {}});
        let _: NetworkCreateOrUpdateRouteTableInput = serde_json::from_value(json).unwrap();
    }
}
