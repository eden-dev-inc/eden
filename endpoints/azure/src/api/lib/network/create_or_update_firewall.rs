...
const API_INFO: ApiInfo<AzureApi, NetworkCreateOrUpdateFirewallInput> = ApiInfo::new(
    EpKind::Azure,
    AzureApi::NetworkCreateOrUpdateFirewall,
    "Create or update a firewall",
    ReqType::Write,
    true,
);
...
mod tests {
    ...
    #[test]
    fn builder_serde() {
        let input = NetworkCreateOrUpdateFirewallInputBuilder::default()
        ...
        assert_eq!(json["type"], "network_create_or_update_firewall");
    }

    #[test]
    fn deserialize_minimal() {
        let json = serde_json::json!({"resource_group": "my-rg", "firewall_name": "my-fw", "location": "eastus", "properties": {}});
        let _: NetworkCreateOrUpdateFirewallInput = serde_json::from_value(json).unwrap();
    }
}
