...
const API_INFO: ApiInfo<AzureApi, NetworkCreateOrUpdateWafPolicyInput> = ApiInfo::new(
    EpKind::Azure,
    AzureApi::NetworkCreateOrUpdateWafPolicy,
...
mod tests {
    ...
    #[test]
    fn builder_serde() {
        let input = NetworkCreateOrUpdateWafPolicyInputBuilder::default()
        ...
        assert_eq!(json["type"], "network_create_or_update_waf_policy");
    }

    #[test]
    fn deserialize_minimal() {
        let json = serde_json::json!({"resource_group": "my-rg", "policy_name": "my-policy", "location": "eastus", "properties": {}});
        let _: NetworkCreateOrUpdateWafPolicyInput = serde_json::from_value(json).unwrap();
    }
}
