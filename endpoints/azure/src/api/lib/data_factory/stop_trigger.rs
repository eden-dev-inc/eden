...
const API_INFO: ApiInfo<AzureApi, DataFactoryStopTriggerInput> =
    ApiInfo::new(EpKind::Azure, AzureApi::DataFactoryStopTrigger, "Stop a Data Factory trigger", ReqType::Write, true);
...
mod tests {
    ...
    #[test]
    fn builder_serde() {
        let input = DataFactoryStopTriggerInputBuilder::default()
        ...
        assert_eq!(json["type"], "data_factory_stop_trigger");
    }

    #[test]
    fn deserialize_minimal() {
        let json = serde_json::json!({"resource_group": "my-rg", "factory_name": "my-factory", "trigger_name": "my-trigger"});
        let _: DataFactoryStopTriggerInput = serde_json::from_value(json).unwrap();
    }
}
