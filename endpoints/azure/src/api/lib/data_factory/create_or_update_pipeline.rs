...
const API_INFO: ApiInfo<AzureApi, DataFactoryCreateOrUpdatePipelineInput> = ApiInfo::new(
    EpKind::Azure,
    AzureApi::DataFactoryCreateOrUpdatePipeline,
    "Create or update a Data Factory pipeline",
    ReqType::Write,
    true,
);
...
mod tests {
    ...
    #[test]
    fn builder_serde() {
        let input = DataFactoryCreateOrUpdatePipelineInputBuilder::default()
        ...
        assert_eq!(json["type"], "data_factory_create_or_update_pipeline");
    }

    #[test]
    fn deserialize_minimal() {
        let json =
            serde_json::json!({"resource_group": "my-rg", "factory_name": "my-factory", "pipeline_name": "my-pipeline", "properties": {}});
        let _: DataFactoryCreateOrUpdatePipelineInput = serde_json::from_value(json).unwrap();
    }
}
