...
const API_INFO: ApiInfo<AzureApi, DataFactoryCreateOrUpdateFactoryInput> = ApiInfo::new(
    EpKind::Azure,
    AzureApi::DataFactoryCreateOrUpdateFactory,
    "Create or update a Data Factory instance",
    ReqType::Write,
    true,
);
...
mod tests {
    ...
    #[test]
    fn builder_serde() {
        let input = DataFactoryCreateOrUpdateFactoryInputBuilder::default()
        ...
        assert_eq!(json["type"], "data_factory_create_or_update_factory");
    }

    #[test]
    fn deserialize_minimal() {
        let json = serde_json::json!({"resource_group": "my-rg", "factory_name": "my-factory", "location": "eastus", "properties": {}});
        let _: DataFactoryCreateOrUpdateFactoryInput = serde_json::from_value(json).unwrap();
    }
}
