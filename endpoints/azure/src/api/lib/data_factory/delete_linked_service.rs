...
const API_INFO: ApiInfo<AzureApi, DataFactoryDeleteLinkedServiceInput> = ApiInfo::new(
    EpKind::Azure,
    AzureApi::DataFactoryDeleteLinkedService,
    "Delete a Data Factory linked service",
    ReqType::Write,
    true,
);
...
mod tests {
    ...
    #[test]
    fn builder_serde() {
        let input = DataFactoryDeleteLinkedServiceInputBuilder::default()
        ...
        assert_eq!(json["type"], "data_factory_delete_linked_service");
    }

    #[test]
    fn deserialize_minimal() {
        let json = serde_json::json!({"resource_group": "my-rg", "factory_name": "my-factory", "linked_service_name": "my-linked-service"});
        let _: DataFactoryDeleteLinkedServiceInput = serde_json::from_value(json).unwrap();
    }
}
