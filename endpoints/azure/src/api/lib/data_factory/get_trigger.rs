...
const API_INFO: ApiInfo<AzureApi, DataFactoryGetTriggerInput> =
    ApiInfo::new(EpKind::Azure, AzureApi::DataFactoryGetTrigger, "Get a Data Factory trigger", ReqType::Read, true);
...
mod tests {
    ...
    #[test]
    fn builder_serde() {
        let input = DataFactoryGetTriggerInputBuilder::default()
        ...
        assert_eq!(json["type"], "data_factory_get_trigger");
    }

    #[test]
    fn deserialize_minimal() {
        let json = serde_json::json!({"resource_group": "my-rg", "factory_name": "my-factory", "trigger_name": "my-trigger"});
        let _: DataFactoryGetTriggerInput = serde_json::from_value(json).unwrap();
    }
}
