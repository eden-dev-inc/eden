...
const API_INFO: ApiInfo<AzureApi, CosmosDbDeleteMongoDatabaseInput> = ApiInfo::new(
    EpKind::Azure,
    AzureApi::CosmosDbDeleteMongoDatabase,
    "Delete a Cosmos DB MongoDB database",
    ReqType::Write,
    true,
);
...
mod tests {
    ...
    #[test]
    fn builder_serde() {
        let input = CosmosDbDeleteMongoDatabaseInputBuilder::default()
        ...
        assert_eq!(json["type"], "cosmosdb_delete_mongo_database");
    }
    ...
    fn deserialize_minimal() {
        ...
        let _: CosmosDbDeleteMongoDatabaseInput = serde_json::from_value(json).unwrap();
    }
}
