...
const API_INFO: ApiInfo<AzureApi, CosmosDbGetSqlContainerInput> = ApiInfo::new(
    EpKind::Azure,
    AzureApi::CosmosDbGetSqlContainer,
    "Get a Cosmos DB SQL container",
    ReqType::Read,
    true,
);
...
mod tests {
    ...
    #[test]
    fn builder_serde() {
        let input = CosmosDbGetSqlContainerInputBuilder::default()
        ...
        assert_eq!(json["type"], "cosmosdb_get_sql_container");
    }
    ...
    fn deserialize_minimal() {
        ...
        let _: CosmosDbGetSqlContainerInput = serde_json::from_value(json).unwrap();
    }
}
