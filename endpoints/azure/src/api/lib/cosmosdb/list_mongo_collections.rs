...
const API_INFO: ApiInfo<AzureApi, CosmosDbListMongoCollectionsInput> = ApiInfo::new(
    EpKind::Azure,
    AzureApi::CosmosDbListMongoCollections,
    "List Cosmos DB MongoDB collections",
    ReqType::Read,
    true,
);
...
mod tests {
    ...
    #[test]
    fn builder_serde() {
        let input = CosmosDbListMongoCollectionsInputBuilder::default()
        ...
        assert_eq!(json["type"], "cosmosdb_list_mongo_collections");
    }
    ...
    fn deserialize_minimal() {
        ...
        let _: CosmosDbListMongoCollectionsInput = serde_json::from_value(json).unwrap();
    }
}
