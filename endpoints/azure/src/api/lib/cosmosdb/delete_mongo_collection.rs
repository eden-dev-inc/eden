...
const API_INFO: ApiInfo<AzureApi, CosmosDbDeleteMongoCollectionInput> = ApiInfo::new(
    EpKind::Azure,
    AzureApi::CosmosDbDeleteMongoCollection,
    "Delete a Cosmos DB MongoDB collection",
    ReqType::Write,
    true,
);
...
mod tests {
    ...
    #[test]
    fn builder_serde() {
        let input = CosmosDbDeleteMongoCollectionInputBuilder::default()
        ...
        assert_eq!(json["type"], "cosmosdb_delete_mongo_collection");
    }
    ...
    fn deserialize_minimal() {
        ...
        let _: CosmosDbDeleteMongoCollectionInput = serde_json::from_value(json).unwrap();
    }
}
