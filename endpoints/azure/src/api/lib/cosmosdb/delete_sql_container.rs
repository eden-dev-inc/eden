...
const API_INFO: ApiInfo<AzureApi, CosmosDbDeleteSqlContainerInput> = ApiInfo::new(
    EpKind::Azure,
    AzureApi::CosmosDbDeleteSqlContainer,
    "Delete a Cosmos DB SQL container",
    ReqType::Write,
    true,
);
...
mod tests {
    ...
    #[test]
    fn builder_serde() {
        let input = CosmosDbDeleteSqlContainerInputBuilder::default()
        ...
        assert_eq!(json["type"], "cosmosdb_delete_sql_container");
    }
    ...
    fn deserialize_minimal() {
        ...
        let _: CosmosDbDeleteSqlContainerInput = serde_json::from_value(json).unwrap();
    }
}
