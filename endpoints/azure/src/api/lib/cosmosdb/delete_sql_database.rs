...
const API_INFO: ApiInfo<AzureApi, CosmosDbDeleteSqlDatabaseInput> = ApiInfo::new(
    EpKind::Azure,
    AzureApi::CosmosDbDeleteSqlDatabase,
    "Delete a Cosmos DB SQL database",
    ReqType::Write,
    true,
);
...
mod tests {
    ...
    #[test]
    fn builder_serde() {
        let input = CosmosDbDeleteSqlDatabaseInputBuilder::default()
        ...
        assert_eq!(json["type"], "cosmosdb_delete_sql_database");
    }
    ...
    fn deserialize_minimal() {
        ...
        let _: CosmosDbDeleteSqlDatabaseInput = serde_json::from_value(json).unwrap();
    }
}
