...
const API_INFO: ApiInfo<AzureApi, CosmosDbDeleteCassandraKeyspaceInput> = ApiInfo::new(
    EpKind::Azure,
    AzureApi::CosmosDbDeleteCassandraKeyspace,
    "Delete a Cosmos DB Cassandra keyspace",
    ReqType::Write,
    true,
);
...
mod tests {
    ...
    #[test]
    fn builder_serde() {
        let input = CosmosDbDeleteCassandraKeyspaceInputBuilder::default()
        ...
        assert_eq!(json["type"], "cosmosdb_delete_cassandra_keyspace");
    }
    ...
    fn deserialize_minimal() {
        ...
        let _: CosmosDbDeleteCassandraKeyspaceInput = serde_json::from_value(json).unwrap();
    }
}
