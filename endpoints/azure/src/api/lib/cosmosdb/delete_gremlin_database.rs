...
const API_INFO: ApiInfo<AzureApi, CosmosDbDeleteGremlinDatabaseInput> = ApiInfo::new(
    EpKind::Azure,
    AzureApi::CosmosDbDeleteGremlinDatabase,
    "Delete a Cosmos DB Gremlin database",
    ReqType::Write,
    true,
);
...
mod tests {
    ...
    #[test]
    fn builder_serde() {
        let input = CosmosDbDeleteGremlinDatabaseInputBuilder::default()
        ...
        assert_eq!(json["type"], "cosmosdb_delete_gremlin_database");
    }
    ...
    fn deserialize_minimal() {
        ...
        let _: CosmosDbDeleteGremlinDatabaseInput = serde_json::from_value(json).unwrap();
    }
}
