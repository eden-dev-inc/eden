...
const API_INFO: ApiInfo<AzureApi, CosmosDbListSqlContainersInput> = ApiInfo::new(
    EpKind::Azure,
    AzureApi::CosmosDbListSqlContainers,
...
mod tests {
    ...
    #[test]
    fn builder_serde() {
        let input = CosmosDbListSqlContainersInputBuilder::default()
        ...
        assert_eq!(json["type"], "cosmosdb_list_sql_containers");
    }
    ...
    fn deserialize_minimal() {
        ...
        let _: CosmosDbListSqlContainersInput = serde_json::from_value(json).unwrap();
    }
}
