...
const API_INFO: ApiInfo<AzureApi, CosmosDbDeleteTableResourceInput> = ApiInfo::new(
    EpKind::Azure,
    AzureApi::CosmosDbDeleteTableResource,
    "Delete a Cosmos DB table resource",
    ReqType::Write,
    true,
);
...
mod tests {
    ...
    #[test]
    fn builder_serde() {
        let input = CosmosDbDeleteTableResourceInputBuilder::default()
        ...
        assert_eq!(json["type"], "cosmosdb_delete_table_resource");
    }
    ...
    fn deserialize_minimal() {
        ...
        let _: CosmosDbDeleteTableResourceInput = serde_json::from_value(json).unwrap();
    }
}
