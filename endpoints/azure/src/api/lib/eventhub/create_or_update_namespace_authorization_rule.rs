...
const API_INFO: ApiInfo<AzureApi, EventHubCreateOrUpdateNamespaceAuthorizationRuleInput> = ApiInfo::new(
    EpKind::Azure,
    AzureApi::EventHubCreateOrUpdateNamespaceAuthorizationRule,
    "Create or update an Event Hub namespace authorization rule",
    ReqType::Write,
    true,
);
...
mod tests {
    ...
    #[test]
    fn builder_serde() {
        let input = EventHubCreateOrUpdateNamespaceAuthorizationRuleInputBuilder::default()
        ...
        assert_eq!(json["type"], "event_hub_create_or_update_namespace_authorization_rule");
    }
    ...
    fn deserialize_minimal() {
        ...
        let _: EventHubCreateOrUpdateNamespaceAuthorizationRuleInput = serde_json::from_value(json).unwrap();
    }
}
