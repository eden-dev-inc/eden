...
const API_INFO: ApiInfo<AzureApi, EventHubGetConsumerGroupInput> = ApiInfo::new(
    EpKind::Azure,
    AzureApi::EventHubGetConsumerGroup,
    "Get a consumer group for an event hub",
    ReqType::Read,
    true,
);
...
mod tests {
    ...
    #[test]
    fn builder_serde() {
        let input = EventHubGetConsumerGroupInputBuilder::default()
