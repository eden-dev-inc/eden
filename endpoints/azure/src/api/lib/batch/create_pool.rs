...
const API_INFO: ApiInfo<AzureApi, BatchCreatePoolInput> =
    ApiInfo::new(EpKind::Azure, AzureApi::BatchCreatePool, "Create a pool in a Batch account", ReqType::Write, true);
...
mod tests {
    ...
    #[test]
    fn builder_serde() {
        let input = BatchCreatePoolInputBuilder::default()
