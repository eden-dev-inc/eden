...
const API_INFO: ApiInfo<AzureApi, CdnGetEndpointInput> =
    ApiInfo::new(EpKind::Azure, AzureApi::CdnGetEndpoint, "Get a CDN endpoint", ReqType::Read, true);
...
mod tests {
    ...
    #[test]
    fn builder_serde() {
        let input = CdnGetEndpointInputBuilder::default()
