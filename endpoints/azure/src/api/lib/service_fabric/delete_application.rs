...
const API_INFO: ApiInfo<AzureApi, ServiceFabricDeleteApplicationInput> = ApiInfo::new(
    EpKind::Azure,
    AzureApi::ServiceFabricDeleteApplication,
...
mod tests {
    ...
    #[test]
    fn builder_serde() {
        let input = ServiceFabricDeleteApplicationInputBuilder::default()
        ...
        assert_eq!(json["type"], "service_fabric_delete_application");
    }

    #[test]
    fn deserialize_minimal() {
        let json = serde_json::json!({"resource_group": "my-rg", "cluster_name": "my-cluster", "application_name": "my-app"});
        let _: ServiceFabricDeleteApplicationInput = serde_json::from_value(json).unwrap();
    }
}
