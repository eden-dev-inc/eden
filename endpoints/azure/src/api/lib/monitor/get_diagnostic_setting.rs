...
const API_INFO: ApiInfo<AzureApi, MonitorGetDiagnosticSettingInput> = ApiInfo::new(
    EpKind::Azure,
    AzureApi::MonitorGetDiagnosticSetting,
...
mod tests {
    ...
    #[test]
    fn builder_serde() {
        let input = MonitorGetDiagnosticSettingInputBuilder::default()
        ...
        assert_eq!(json["type"], "monitor_get_diagnostic_setting");
    }

    #[test]
    fn deserialize_minimal() {
        let json = serde_json::json!({"resource_uri": "/subscriptions/sub1/resourceGroups/rg1/providers/Microsoft.Compute/virtualMachines/vm1", "setting_name": "my-setting"});
        let _: MonitorGetDiagnosticSettingInput = serde_json::from_value(json).unwrap();
    }
}
