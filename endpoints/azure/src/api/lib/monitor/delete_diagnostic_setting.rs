...
const API_INFO: ApiInfo<AzureApi, MonitorDeleteDiagnosticSettingInput> = ApiInfo::new(
    EpKind::Azure,
    AzureApi::MonitorDeleteDiagnosticSetting,
...
mod tests {
    ...
    #[test]
    fn builder_serde() {
        let input = MonitorDeleteDiagnosticSettingInputBuilder::default()
            .resource_uri("/subscriptions/sub1/resourceGroups/rg1/providers/Microsoft.Compute/virtualMachines/vm1")
            .diagnostic_setting_name("my-setting")
            .build()
            .unwrap();
        let json = serde_json::to_value(&input).unwrap();
        assert_eq!(json["type"], "monitor_delete_diagnostic_setting");
    }
    ...
    fn deserialize_minimal() {
        ...
        let _: MonitorDeleteDiagnosticSettingInput = serde_json::from_value(json).unwrap();
    }
}
