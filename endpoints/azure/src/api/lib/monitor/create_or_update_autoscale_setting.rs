...
const API_INFO: ApiInfo<AzureApi, MonitorCreateOrUpdateAutoscaleSettingInput> = ApiInfo::new(
    EpKind::Azure,
    AzureApi::MonitorCreateOrUpdateAutoscaleSetting,
...
mod tests {
    ...
    #[test]
    fn builder_serde() {
        let input = MonitorCreateOrUpdateAutoscaleSettingInputBuilder::default()
        ...
        assert_eq!(json["type"], "monitor_create_or_update_autoscale_setting");
    }
    ...
    fn deserialize_minimal() {
        ...
        let _: MonitorCreateOrUpdateAutoscaleSettingInput = serde_json::from_value(json).unwrap();
    }
}
