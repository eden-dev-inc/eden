...
const API_INFO: ApiInfo<AzureApi, RedisCacheCreateOrUpdateFirewallRuleInput> = ApiInfo::new(
    EpKind::Azure,
    AzureApi::RedisCacheCreateOrUpdateFirewallRule,
...
mod tests {
    ...
    #[test]
    fn builder_serde() {
        let input = RedisCacheCreateOrUpdateFirewallRuleInputBuilder::default()
        ...
        assert_eq!(json["type"], "redis_cache_create_or_update_firewall_rule");
    }
    ...
    fn deserialize_minimal() {
        ...
        let _: RedisCacheCreateOrUpdateFirewallRuleInput = serde_json::from_value(json).unwrap();
    }
}
