...
const API_INFO: ApiInfo<AzureApi, MaintenanceCreateOrUpdateConfigurationInput> = ApiInfo::new(
    EpKind::Azure,
    AzureApi::MaintenanceCreateOrUpdateConfiguration,
...
mod tests {
    ...
    #[test]
    fn builder_serde() {
        let input = MaintenanceCreateOrUpdateConfigurationInputBuilder::default()
        ...
        assert_eq!(json["type"], "maintenance_create_or_update_configuration");
    }

    #[test]
    fn deserialize_minimal() {
        let json =
            serde_json::json!({"resource_group": "my-rg", "configuration_name": "my-config", "location": "eastus", "properties": {}});
        let _: MaintenanceCreateOrUpdateConfigurationInput = serde_json::from_value(json).unwrap();
    }
}
