...
const API_INFO: ApiInfo<AzureApi, ManagedApplicationsCreateOrUpdateInput> = ApiInfo::new(
    EpKind::Azure,
    AzureApi::ManagedApplicationsCreateOrUpdate,
...
mod tests {
    ...
    #[test]
    fn builder_serde() {
        let input = ManagedApplicationsCreateOrUpdateInputBuilder::default()
        ...
        assert_eq!(json["type"], "managed_applications_create_or_update");
    }

    #[test]
    fn deserialize_minimal() {
        let json = serde_json::json!({"resource_group": "my-rg", "application_name": "my-app", "location": "eastus", "kind": "ServiceCatalog", "properties": {}});
        let _: ManagedApplicationsCreateOrUpdateInput = serde_json::from_value(json).unwrap();
    }
}
