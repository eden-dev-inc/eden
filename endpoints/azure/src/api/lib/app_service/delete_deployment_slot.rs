...
const API_INFO: ApiInfo<AzureApi, AppServiceDeleteDeploymentSlotInput> = ApiInfo::new(
    EpKind::Azure,
    AzureApi::AppServiceDeleteDeploymentSlot,
...
mod tests {
    ...
    #[test]
    fn builder_serde() {
        let input = AppServiceDeleteDeploymentSlotInputBuilder::default()
        ...
        assert_eq!(json["type"], "app_service_delete_deployment_slot");
    }
    ...
    fn deserialize_minimal() {
        ...
        let _: AppServiceDeleteDeploymentSlotInput = serde_json::from_value(json).unwrap();
    }
}
