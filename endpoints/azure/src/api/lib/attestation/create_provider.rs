...
const API_INFO: ApiInfo<AzureApi, AttestationCreateProviderInput> = ApiInfo::new(
    EpKind::Azure,
    AzureApi::AttestationCreateProvider,
...
mod tests {
    ...
    #[test]
    fn builder_serde() {
        let input = AttestationCreateProviderInputBuilder::default()
        ...
        assert_eq!(json["type"], "attestation_create_provider");
    }

    #[test]
    fn deserialize_minimal() {
        let json = serde_json::json!({"resource_group": "my-rg", "provider_name": "my-provider", "location": "eastus", "properties": {}});
        let _: AttestationCreateProviderInput = serde_json::from_value(json).unwrap();
    }
}
