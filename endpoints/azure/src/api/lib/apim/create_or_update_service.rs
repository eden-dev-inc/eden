...
const API_INFO: ApiInfo<AzureApi, ApimCreateOrUpdateServiceInput> = ApiInfo::new(
    EpKind::Azure,
    AzureApi::ApimCreateOrUpdateService,
...
mod tests {
    ...
    #[test]
    fn builder_serde() {
        let input = ApimCreateOrUpdateServiceInputBuilder::default()
        ...
        assert_eq!(json["type"], "apim_create_or_update_service");
    }

    #[test]
    fn deserialize_minimal() {
        let json = serde_json::json!({"resource_group": "my-rg", "service_name": "my-apim", "location": "eastus"});
        let _: ApimCreateOrUpdateServiceInput = serde_json::from_value(json).unwrap();
    }
}
