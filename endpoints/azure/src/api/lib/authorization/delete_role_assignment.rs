...
const API_INFO: ApiInfo<AzureApi, AuthorizationDeleteRoleAssignmentInput> = ApiInfo::new(
    EpKind::Azure,
    AzureApi::AuthorizationDeleteRoleAssignment,
...
mod tests {
    ...
    #[test]
    fn builder_serde() {
        let input = AuthorizationDeleteRoleAssignmentInputBuilder::default()
            .scope("/subscriptions/00000000-0000-0000-0000-000000000000")
            .role_assignment_name("my-assignment")
            .build()
            .unwrap();
        let json = serde_json::to_value(&input).unwrap();
        assert_eq!(json["type"], "authorization_delete_role_assignment");
    }
    ...
    fn deserialize_minimal() {
        ...
        let _: AuthorizationDeleteRoleAssignmentInput = serde_json::from_value(json).unwrap();
    }
}
