...
const API_INFO: ApiInfo<AzureApi, FluidRelayCreateOrUpdateInput> = ApiInfo::new(
    EpKind::Azure,
    AzureApi::FluidRelayCreateOrUpdate,
...
mod tests {
    ...
    #[test]
    fn builder_serde() {
        let input = FluidRelayCreateOrUpdateInputBuilder::default()
        ...
        assert_eq!(json["type"], "fluid_relay_create_or_update");
    }

    #[test]
    fn deserialize_minimal() {
        let json = serde_json::json!({"resource_group": "my-rg", "server_name": "my-server", "location": "eastus", "properties": {}});
        let _: FluidRelayCreateOrUpdateInput = serde_json::from_value(json).unwrap();
    }
}
