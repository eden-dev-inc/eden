...
const API_INFO: ApiInfo<AzureApi, FunctionsCreateOrUpdateFunctionAppInput> = ApiInfo::new(
    EpKind::Azure,
    AzureApi::FunctionsCreateOrUpdateFunctionApp,
...
mod tests {
    ...
    #[test]
    fn builder_serde() {
        let input = FunctionsCreateOrUpdateFunctionAppInputBuilder::default()
        ...
        assert_eq!(json["type"], "functions_create_or_update_function_app");
    }

    #[test]
    fn deserialize_minimal() {
        let json = serde_json::json!({"resource_group": "my-rg", "name": "my-func", "location": "eastus"});
        let _: FunctionsCreateOrUpdateFunctionAppInput = serde_json::from_value(json).unwrap();
    }
}
