...
const API_INFO: ApiInfo<AzureApi, NotificationHubsCreateOrUpdateNamespaceInput> = ApiInfo::new(
    EpKind::Azure,
    AzureApi::NotificationHubsCreateOrUpdateNamespace,
    "Create or update a Notification Hub namespace",
    ReqType::Write,
    true,
);
...
mod tests {
    ...
    #[test]
    fn builder_serde() {
        let input = NotificationHubsCreateOrUpdateNamespaceInputBuilder::default()
        ...
        assert_eq!(json["type"], "notification_hubs_create_or_update_namespace");
    }

    #[test]
    fn deserialize_minimal() {
        let json = serde_json::json!({"resource_group": "my-rg", "namespace_name": "my-ns", "location": "eastus", "properties": {}});
        let _: NotificationHubsCreateOrUpdateNamespaceInput = serde_json::from_value(json).unwrap();
    }
}
