...
const API_INFO: ApiInfo<AzureApi, VmwareGetClusterInput> =
    ApiInfo::new(EpKind::Azure, AzureApi::VmwareGetCluster, "Get a VMware cluster", ReqType::Read, true);
...
mod tests {
    ...
    #[test]
    fn builder_serde() {
        let input = VmwareGetClusterInputBuilder::default()
