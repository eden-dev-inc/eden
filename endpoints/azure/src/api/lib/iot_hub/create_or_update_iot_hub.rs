...
const API_INFO: ApiInfo<AzureApi, IotHubCreateOrUpdateIotHubInput> = ApiInfo::new(
    EpKind::Azure,
    AzureApi::IotHubCreateOrUpdateIotHub,
...
mod tests {
    ...
    #[test]
    fn builder_serde() {
        let input = IotHubCreateOrUpdateIotHubInputBuilder::default()
        ...
        assert_eq!(json["type"], "iot_hub_create_or_update_iot_hub");
    }

    #[test]
    fn deserialize_minimal() {
        let json = serde_json::json!({"resource_group": "my-rg", "iot_hub_name": "my-hub", "location": "eastus", "properties": {}});
        let _: IotHubCreateOrUpdateIotHubInput = serde_json::from_value(json).unwrap();
    }
}
