...
const API_INFO: ApiInfo<AzureApi, IotHubGetConsumerGroupInput> = ApiInfo::new(
    EpKind::Azure,
    AzureApi::IotHubGetConsumerGroup,
    "Get a consumer group for an IoT Hub",
    ReqType::Read,
    true,
);
...
mod tests {
    ...
    #[test]
    fn builder_serde() {
        let input = IotHubGetConsumerGroupInputBuilder::default()
        ...
        assert_eq!(json["type"], "iot_hub_get_consumer_group");
    }
    ...
    fn deserialize_minimal() {
        ...
        let _: IotHubGetConsumerGroupInput = serde_json::from_value(json).unwrap();
    }
}
