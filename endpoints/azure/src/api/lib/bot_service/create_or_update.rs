...
const API_INFO: ApiInfo<AzureApi, BotServiceCreateOrUpdateInput> = ApiInfo::new(
    EpKind::Azure,
    AzureApi::BotServiceCreateOrUpdate,
    "Create or update a Bot Service bot",
    ReqType::Write,
    true,
);
...
mod tests {
    ...
    #[test]
    fn builder_serde() {
        let input = BotServiceCreateOrUpdateInputBuilder::default()
        ...
        assert_eq!(json["type"], "bot_service_create_or_update");
    }

    #[test]
    fn deserialize_minimal() {
        let json = serde_json::json!({"resource_group": "my-rg", "bot_name": "my-bot", "location": "eastus", "properties": {}});
        let _: BotServiceCreateOrUpdateInput = serde_json::from_value(json).unwrap();
    }
}
