...
const API_INFO: ApiInfo<AzureApi, AppInsightsCreateOrUpdateInput> = ApiInfo::new(
    EpKind::Azure,
    AzureApi::AppInsightsCreateOrUpdate,
    "Create or update an Application Insights component",
    ReqType::Write,
    true,
);
...
mod tests {
    ...
    #[test]
    fn builder_serde() {
        let input = AppInsightsCreateOrUpdateInputBuilder::default()
        ...
        assert_eq!(json["type"], "app_insights_create_or_update");
    }

    #[test]
    fn deserialize_minimal() {
        let json = serde_json::json!({"resource_group": "my-rg", "component_name": "my-component", "location": "eastus", "kind": "web", "properties": {}});
        let _: AppInsightsCreateOrUpdateInput = serde_json::from_value(json).unwrap();
    }
}
