...
const API_INFO: ApiInfo<AzureApi, ComputeCreateOrUpdateVmssInput> = ApiInfo::new(
    EpKind::Azure,
    AzureApi::ComputeCreateOrUpdateVmss,
...
mod tests {
    ...
    #[test]
    fn builder_serde() {
        let input = ComputeCreateOrUpdateVmssInputBuilder::default()
        ...
        assert_eq!(json["type"], "compute_create_or_update_vmss");
    }

    #[test]
    fn deserialize_minimal() {
        let json = serde_json::json!({"resource_group": "my-rg", "vmss_name": "my-vmss", "location": "eastus", "properties": {}});
        let _: ComputeCreateOrUpdateVmssInput = serde_json::from_value(json).unwrap();
    }
}
