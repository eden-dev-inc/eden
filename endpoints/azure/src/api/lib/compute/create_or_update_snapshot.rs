...
const API_INFO: ApiInfo<AzureApi, ComputeCreateOrUpdateSnapshotInput> = ApiInfo::new(
    EpKind::Azure,
    AzureApi::ComputeCreateOrUpdateSnapshot,
...
mod tests {
    ...
    #[test]
    fn builder_serde() {
        let input = ComputeCreateOrUpdateSnapshotInputBuilder::default()
        ...
        assert_eq!(json["type"], "compute_create_or_update_snapshot");
    }

    #[test]
    fn deserialize_minimal() {
        let json = serde_json::json!({"resource_group": "my-rg", "snapshot_name": "my-snapshot", "location": "eastus", "properties": {}});
        let _: ComputeCreateOrUpdateSnapshotInput = serde_json::from_value(json).unwrap();
    }
}
