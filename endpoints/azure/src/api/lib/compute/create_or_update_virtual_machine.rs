...
const API_INFO: ApiInfo<AzureApi, ComputeCreateOrUpdateVirtualMachineInput> = ApiInfo::new(
    EpKind::Azure,
    AzureApi::ComputeCreateOrUpdateVirtualMachine,
...
mod tests {
    ...
    #[test]
    fn builder_serde() {
        let input = ComputeCreateOrUpdateVirtualMachineInputBuilder::default()
        ...
        assert_eq!(json["type"], "compute_create_or_update_virtual_machine");
    }

    #[test]
    fn deserialize_minimal() {
        let json = serde_json::json!({"resource_group": "my-rg", "vm_name": "my-vm", "location": "eastus", "properties": {}});
        let _: ComputeCreateOrUpdateVirtualMachineInput = serde_json::from_value(json).unwrap();
    }
}
