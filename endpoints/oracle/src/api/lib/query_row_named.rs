...
const API_INFO: ApiInfo<OracleApi, QueryRowNamedInput> =
    ApiInfo::new(EpKind::Oracle, OracleApi::QueryRowNamed, "Oracle Query", ReqType::Write, true);

crate::oracle_endpoint! {
    struct QueryRowNamedInput {
        query: String,
