...
const API_INFO: ApiInfo<OracleApi, QueryRowAsNamedInput> =
    ApiInfo::new(EpKind::Oracle, OracleApi::QueryRowAsNamed, "Oracle Query", ReqType::Write, true);

crate::oracle_endpoint! {
    struct QueryRowAsNamedInput {
        query: String,
