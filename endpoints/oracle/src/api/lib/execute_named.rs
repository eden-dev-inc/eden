...
const API_INFO: ApiInfo<OracleApi, ExecuteNamedInput> =
    ApiInfo::new(EpKind::Oracle, OracleApi::ExecuteNamed, "Oracle execute named", ReqType::Write, true);

crate::oracle_endpoint! {
    struct ExecuteNamedInput {
        sql: String,
