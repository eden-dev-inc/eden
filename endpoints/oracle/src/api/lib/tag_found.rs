...
const API_INFO: ApiInfo<OracleApi, TagFoundInput> =
    ApiInfo::new(EpKind::Oracle, OracleApi::TagFound, "Oracle execute named", ReqType::Write, true);

crate::oracle_endpoint! {
    struct TagFoundInput {}
}
