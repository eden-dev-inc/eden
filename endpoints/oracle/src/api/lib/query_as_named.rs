...
const API_INFO: ApiInfo<OracleApi, QueryAsNamedInput> =
    ApiInfo::new(EpKind::Oracle, OracleApi::QueryAsNamed, "Oracle Query", ReqType::Write, true);

crate::oracle_endpoint! {
    struct QueryAsNamedInput {
        query: String,
