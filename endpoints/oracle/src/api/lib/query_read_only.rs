...
const API_INFO: ApiInfo<OracleApi, QueryReadOnlyInput> =
    ApiInfo::new(EpKind::Oracle, OracleApi::QueryReadOnly, "Oracle Read-Only Query", ReqType::Read, true);

crate::oracle_endpoint! {
    struct QueryReadOnlyInput {
        query: String,
        params: Vec<SqlParam>
    }
}
