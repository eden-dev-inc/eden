...
const API_INFO: ApiInfo<OracleApi, QueryNamedReadOnlyInput> =
    ApiInfo::new(EpKind::Oracle, OracleApi::QueryNamedReadOnly, "Oracle Read-Only Query Named", ReqType::Read, true);

crate::oracle_endpoint! {
    struct QueryNamedReadOnlyInput {
        query: String,
