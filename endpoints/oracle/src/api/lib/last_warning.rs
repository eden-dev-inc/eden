...
const API_INFO: ApiInfo<OracleApi, LastWarningInput> =
    ApiInfo::new(EpKind::Oracle, OracleApi::LastWarning, "Oracle execute named", ReqType::Write, true);

crate::oracle_endpoint! {
    struct LastWarningInput {}
}
