...
const API_INFO: ApiInfo<OracleApi, QueryRowAsNamedReadOnlyInput> = ApiInfo::new(
    EpKind::Oracle,
    OracleApi::QueryRowAsNamedReadOnly,
    "Oracle Read-Only Query Row As Named",
    ReqType::Read,
    true,
);

crate::oracle_endpoint! {
    struct QueryRowAsNamedReadOnlyInput {
        query: String,
