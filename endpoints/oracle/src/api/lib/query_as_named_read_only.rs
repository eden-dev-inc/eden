...
const API_INFO: ApiInfo<OracleApi, QueryAsNamedReadOnlyInput> = ApiInfo::new(
    EpKind::Oracle,
    OracleApi::QueryAsNamedReadOnly,
    "Oracle Read-Only Query As Named",
    ReqType::Read,
    true,
);

crate::oracle_endpoint! {
    struct QueryAsNamedReadOnlyInput {
        query: String,
