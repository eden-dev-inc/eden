...
#[macro_export]
macro_rules! clickhouse_endpoint {
    (
        $kind:ident,
        $api_info:expr,
        struct {
        ...
        paste::paste! {
            ...
            impl [<$kind Input>] {
                #[allow(dead_code)]
                fn clickhouse_operation_todo() {
                    todo!("Determine if we want to derive here or in the clickhouse crate")
                }
            ...
            #[ctor::ctor]
            fn [<__register_clickhouse_operation_for_ $kind>]() {
