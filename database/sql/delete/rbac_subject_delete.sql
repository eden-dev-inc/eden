WITH control_delete AS (
    WITH tombstone AS (
        INSERT INTO rbac_control_subject_tombstones (org_uuid, subject_kind, subject_uuid, version_ms, version_seq, updated_at)
        ...
        DO UPDATE SET
            ...
            updated_at = NOW()
        WHERE (rbac_control_subject_tombstones.version_ms, rbac_control_subject_tombstones.version_seq) < (EXCLUDED.version_ms, EXCLUDED.version_seq)
        RETURNING 1
    )
    UPDATE rbac_control
    SET is_active = FALSE,
